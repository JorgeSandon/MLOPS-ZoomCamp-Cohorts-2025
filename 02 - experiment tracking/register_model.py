...
def run_register_model(data_path: str, top_n: int):
    ...
    # Obtener los runs del experimento de HPO
    ...
    # Entrenar y loggear los mejores modelos
    for run in runs:
        train_and_log_model(data_path=data_path, params=run.data.params)

    # Obtener el mejor modelo según test_rmse
    ...
    print(f"✅ Best model registered: run_id={run_id}, test RMSE={best_run.data.metrics['test_rmse']:.3f}")
